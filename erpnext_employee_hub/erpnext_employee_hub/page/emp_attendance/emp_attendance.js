...
function get_data(filters = {}) {
	frappe.call({
		method: 'erpnext_employee_hub.erpnext_employee_hub.page.emp_attendance.emp_attendance.get_attendance_data',
...
frappe.pages['emp-attendance'].on_page_load = function (wrapper) {
	const page_filters = [
		{
			label: 'Employee',
			fieldtype: 'Link',
